...
region = st.selectbox("Región", options=["Noreste", "Noroeste", "Sureste", "Suroeste"])

# Conversión de variables categóricas
sexo_fact = 0 if sexo == "Femenino" else 1
fumador_fact = 1 if fumador == "Sí" else 0
region_dict = {"Noreste": 0, "Noroeste": 1, "Sureste": 2, "Suroeste": 3}
region_fact = region_dict[region]

# Preparar los datos para el modelo
entrada_usuario = np.array([[edad, imc, sexo_fact, hijos, fumador_fact, region_fact]])
